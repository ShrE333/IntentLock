/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 65d42fe82bf663c7a6d68b116c8765a1)
...
interface __BaseEnv_Env {
	...
	PurchaseAgent: DurableObjectNamespace<import("./src/index").PurchaseAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PurchaseAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPROVAL_SIGNING_SECRET" | "DATABASE_URL" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "RAZORPAY_KEY_ID" | "RAZORPAY_KEY_SECRET" | "RAZORPAY_WEBHOOK_SECRET">> {}
}
